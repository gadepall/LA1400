...
\end{problem}
\solution
\lstinputlisting{./codes/solution/cprogs/mul.c}
\begin{problem}
...
\end{problem}
\solution
\lstinputlisting{./codes/solution/cprogs/main.c}
\begin{problem}
...
%\end{problem}
\begin{problem}
Write all the required C routines for the calculator in Problem \ref{prob:calc} and generate the shared libraries.
\end{problem}
...
\end{problem}
\solution
\lstinputlisting{./codes/solution/pythonprogs/mul.py}
\begin{problem}
Call the function written above in the Python GUI calculator to perform multipication.
\end{problem}

\solution
Download \textbf{calc\_mul.py} file from the \href{http://tlc.iith.ac.in/img/LA1400/calc_mul.py}{\url{http://tlc.iith.ac.in/img/LA1400/calc_mul.py}} and save it in directory where \textbf{mul.c} is saved.  Execute  \textbf{calc\_mul.py}.

\begin{problem}
Download \textbf{calc\_sol.py} from \href{http://tlc.iith.ac.in/img/LA1400/calc_sol.py}{\url{http://tlc.iith.ac.in/img/LA1400/calc_sol.py}} and 
use C routines in \textbf{calc\_sol.py} for all arithmetic operations in the calculator.
\end{problem}
\end{document}
